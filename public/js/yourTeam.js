...
querySelectorAll('.selectedPlayer').forEach(element => {
    element.addEventListener('drag:start', function() {
        this.style.setProperty('opacity', '0')
            //var test = document.querySelector(".selectedPlayer > [draggable]");
...
wc_team.pitch = function() {
    ...
    var field = function() {
        ...
        markings = function() {
            ...
            // Penalty arcconsole.log('start')h.PI, -1.9 * Math.PI, true);
            this.strokeStyle = "white";
            this.stroke();
...
wc_team.dragDrap = function() {
    ...
    var position,
        ...
        dragStart = function(e) {
            ...
            const event = new Event('drag:start')
